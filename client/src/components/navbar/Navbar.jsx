  ...
  return (
    <div className="flex justify-between pt-3 mx-3 md:mx-7 ">
      <div className="flex self-center justify-center ">
        <div className="self-center lg:hidden" onClick={() => setOpenMenu(!openMenu)}>
          {openMenu ? (
        ...
        <div className="self-center font-extrabold sm:mx-3 mt-4 flex min-w-[145px] sm:min-w-[150px] ">
          <img src={mode === "dark" ? logoImage : logoImageDark} alt="logoImage" className="w-[25px] h-[31.6px]  sm:w-[30px] sm:h-[38px] mx-1"/>
      ...
      <div className="self-center  z-20 hidden lg:flex">
        <div className="self-center mx-2">
          <DarkModeToggle mode={mode} dark="dark" light="light" size="sm"
            inactiveTrackColor="#e2e8f0" inactiveTrackColorOnHover="#f8fafc" inactiveTrackColorOnActive="#cbd5e1" inactiveThumbColor="#1e293b"
            activeTrackColor="#334155" activeTrackColorOnHover="#1e293b" activeTrackColorOnActive="#0f172a" activeThumbColor="#e2e8f0"
