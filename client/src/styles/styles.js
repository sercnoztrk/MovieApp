export const styles = {
  sideBarItem: "flex pl-7 text-[17px] md:text-[19px]  py-4 dark:hover:bg-[#29263b] hover:bg-zinc-300 rounded-r-xl mr-1 cursor-pointer  duration-75 hover:border-l-[3px] border-btn ",
